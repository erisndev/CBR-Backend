...
const sendBookingConfirmation = async (booking) => {
  ...
  const htmlContent = `
    ...
    <head>
      ...
      <title>Booking Confirmation - Coast Beach Resort</title>
        ...
        <div class="content">
          ...
          <div class="section">
            ...
            <p style="font-size: 16px; color: #64748b; line-height: 1.7;">
              ...
              Thank you for choosing Coast Beach Resort for your upcoming stay! We're thrilled to have you as our guest and look forward to providing you with an unforgettable experience.
            </p>
          </div>
  ...
  const mailOptions = {
    ...
    subject: "Booking Confirmation - Paradise Resort",
    html: htmlContent,
  };
